...
!MESSAGE No configuration specified.  Defaulting to ddex1 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "ddex1 - Win32 Release" && "$(CFG)" != "ddex1 - Win32 Debug"
...
!MESSAGE 
!MESSAGE "ddex1 - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "ddex1 - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "ddex1 - Win32 Debug"
MTL=mktyplib.exe
CPP=cl.exe
RSC=rc.exe
...
ALL : "$(OUTDIR)\ddex1.exe"

CLEAN : 
	-@erase "$(INTDIR)\ddex1.obj"
	-@erase "$(INTDIR)\ddex1.res"
	-@erase "$(OUTDIR)\ddex1.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "..\..\include" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)/ddex1.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/ddex1.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/ddex1.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=dxguid.lib ddraw.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/ddex1.pdb" /machine:I386 /out:"$(OUTDIR)/ddex1.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ddex1.obj" \
	"$(INTDIR)\ddex1.res"

"$(OUTDIR)\ddex1.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\ddex1.exe"
	-@erase "$(OUTDIR)\ddex1.ilk"
	-@erase "$(OUTDIR)\ddex1.pdb"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "..\..\include" /D "WIN32" /D\
 "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)/ddex1.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.\.
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)/ddex1.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/ddex1.bsc" 
...
LINK32_FLAGS=dxguid.lib ddraw.lib kernel32.lib user32.lib gdi32.lib\
 ...
 /pdb:"$(OUTDIR)/ddex1.pdb" /debug /machine:I386 /out:"$(OUTDIR)/ddex1.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ddex1.obj" \
	"$(INTDIR)\ddex1.res"
...
"$(INTDIR)\ddex1.obj" : $(SOURCE) $(DEP_CPP_DDEX1) "$(INTDIR)"
...
"$(INTDIR)\ddex1.res" : $(SOURCE) $(DEP_RSC_DDEX1_) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
